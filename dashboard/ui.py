...
DEFS = {
    ...
    "meetings_booked": "Every meeting booked in the window. Booked ≠ held — the gap is mostly meetings with no outcome logged, not cancellations.",
    "meetings_held": "The rep marked the meeting as happened in HubSpot.",
    "meetings_held_any": "Meeting happened = CA marked it held on HubSpot, or a Gong recording happened.",
    ...
    "coverage_pct": "Of the owned accounts that are workable today (excludes customers, open deals, and accounts resting after a recent loss/churn — same rule as the neglected list), the share this CA personally touched in the window.",
