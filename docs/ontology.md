...
| **Manual email** | An email a human actually wrote and sent (from Gmail or typed in HubSpot), to at least one person outside Encord. | The automated/manual split for emails is a best-effort inference from *which tool logged it* — good, not perfect. |
